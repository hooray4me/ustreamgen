...
services:
  streamgen:
    ...
    environment:
      - PUID=1000
      - PGID=1000
      - ALL=true #when true a single list of movies, series and events is used. flase for multiple lists
      ...
      - TZ=America/Chicago
      - ALLURL=https://tvnow.best/api/list/user/pass/m3u8/movies/ # Full M3U Provider URL for all content in one list **ALL must be true
